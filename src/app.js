...
function deal() {
    ...
    $('#dealer').append('<li><img src="assets/cards/' + theDealerHand[0] + '" /></li>');
    ...
    if (blackjack) {
        ...
        $('#dealer').append('<li><img src="assets/cards/' + theDealerHand[1] + '" /></li>');
        theGame.playerWin = true;
        credits = credits + thisPlay.bet * 2.5;
        thisPlay.bet = 0;
        $('#credits').html('Credits: ' + credits);
...
function addBet(num) {
    ...
    if (num <= credits) {
        ...
        thisPlay.bet = thisPlay.bet + credits;
...
function stay() {
    ...
    if (theGame.playerWin) {
        credits = credits + thisPlay.bet * 2;
        thisPlay.bet = 0;
    } else {
        if (theGame.push) {
            credits = credits + thisPlay.bet;
            thisPlay.bet = 0;
        } else {
            if (theGame.bust === true) {
